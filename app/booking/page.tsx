    ...
    <>
      ...
      <section className="booking-hero">
        <div className="container">
          <div className="eyebrow" style={{ color: 'var(--sky)', marginBottom: 14 }}>Schedule Service</div>
          <h1>Book Your<br /><span style={{ WebkitTextStroke: '2px #fff', color: 'transparent' }}>Appointment</span></h1>
            ...
            <div className="booking-form-card">
              ...
              {status === 'success' ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="btn btn-red" style={{ width: '100%', justifyContent: 'center', marginTop: 4 }} disabled={status === 'loading'}>
